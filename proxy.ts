...
export default function proxy(request: NextRequest) {
    ...
    if (pathname.startsWith('/api') || pathname.startsWith('/actuator') || pathname.startsWith('/oauth2') || pathname.startsWith('/login/oauth2/code') || pathname.startsWith('/_next')) {
...
export const config = {
    ...
    matcher: "/((?!api|actuator|oauth2|login/oauth2/code|trpc|_next|_vercel|mock-api|.*\\..*).*)",
};